...
-- Note: animations.enabled = false in the old config was a master toggle;
-- to disable everything, wrap the above hl.animation() calls in `if false then ... end`
-- or set enabled = false on each. Master toggle field TBD in Lua API.
